    ...
    <div className="flex">
      {type ? (
        ...
        px-3 py-1 font-semibold hover:bg-[#3062e0] flex items-center gap-2"
          ...
          href={`https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id=${import.meta.env.VITE_CLIENT_ID}&redirect_uri=${encodeURIComponent(redirectUri)}&scope=openid%20https://mail.google.com/%20https://www.googleapis.com/auth/userinfo.email%20https://www.googleapis.com/auth/userinfo.profile&access_type=offline&state=${orgMemberId + "url=" + currentUrl}&orgMemberId=${orgMemberId}&prompt=consent`}
        >
          <span>{title}</span>
