...
export default function CreateOrganization({ reload, setReload }: any) {
    ...
    try {
      ...
      if (error instanceof z.ZodError) {
        error.errors.forEach((err) => {
          toast({
            title: "Error Occured pelaes provide all details",
            ...
            <div className="flex items-center justify-center w-full">
              {!filePreview ? (
                <label
                  ...
                  className="flex flex-col items-center justify-center w-[500px] h-[250px] border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100"
                >
