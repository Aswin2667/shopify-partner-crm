...
const Notes = () => {
  ...
  const fetchNotes = async () => {
    try {
      const response = await axiosInstance.get(`/lead-notes/${leadId}`);
  ...
  return (
    <div>
      ...
      <div className="h-[700px] overflow-scroll p-3">
        <ol className="relative border-s list-none  min-w-full border-gray-200 dark:border-gray-700">
          {notes.map((note: any) => {
