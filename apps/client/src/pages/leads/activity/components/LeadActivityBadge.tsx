...
const badgeColors: { [key in LeadActivityType]: string } = {
  ...
  [LeadActivityType.MAIL]: "bg-indigo-100 text-indigo-800",
  ...
  [LeadActivityType.SUBSCRIPTION_APPROACHING_CAPPED_AMOUNT]:
    "bg-yellow-200 text-yellow-900",
  [LeadActivityType.SUBSCRIPTION_CAPPED_AMOUNT_UPDATED]:
    "bg-blue-300 text-blue-900",
  [LeadActivityType.SUBSCRIPTION_CHARGE_ACCEPTED]:
  ...
  [LeadActivityType.SUBSCRIPTION_CHARGE_DECLINED]:
