...
const LeadRelationShipUnInstalled = ({activity}:any) => {
          ...
          <time className="mb-1 text-xs font-normal text-gray-400 sm:order-last sm:mb-0">
            ...
            <div className="flex-grow">
              <div className="flex items-center space-x-2">
                <span className="font-semibold">{activity.data.payload.shop.myshopifyDomain}</span>
...
export default LeadRelationShipUnInstalled